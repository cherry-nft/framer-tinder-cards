...
/*
 * Documentation:
 * AI Chat Suggestion — https://app.subframe.com/library?component=AI+Chat+Suggestion_b66d445b-b9c7-4cf6-82e2-4f1130e68f92
 */
  ...
  return (
    <div
      className={SubframeCore.twClassNames(
        "group/b66d445b flex cursor-pointer items-center gap-2 rounded bg-neutral-50 pt-2 pr-2 pb-2 pl-2 hover:bg-neutral-100",
        className
      )}
      ref={ref as any}
      {...otherProps}
